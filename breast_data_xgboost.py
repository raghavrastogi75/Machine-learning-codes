# -*- coding: utf-8 -*-
"""
Created on Sun Apr 30 22:36:45 2017
...
# load data
data = read_csv('https://archive.ics.uci.edu/ml/machine-learning-databases/breast-cancer-wisconsin/breast-cancer-wisconsin.data', header=None)
dataset = data.values
